<li component="post" class="posts-list-item row<!-- IF ../deleted --> deleted<!-- ELSE --><!-- IF ../topic.deleted --> deleted<!-- ENDIF --><!-- ENDIF --><!-- IF ../isNSFW --> containsNSFW<!-- ENDIF -->" data-pid="{../pid}" data-uid="{../uid}">
